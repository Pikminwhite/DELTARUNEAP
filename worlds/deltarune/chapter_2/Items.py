...
chapter2_conditional_items = {
    ...
    Ch2Items.egg.value: ConditionalItemData(
        ...
        lambda world: (not world.is_weird_route() or world.is_all_routes()) and world.is_hidden_items_randomized(),
        [ItemGroups.eggs],
    ),
    ...
    Ch2Items.dealmaker.value: ConditionalItemData(
        ...
        ItemClassification.useful,
        lambda world: (not world.is_weird_route() or world.is_all_routes()) and world.is_secret_bosses_randomized(),
        [ItemGroups.armors],
    ),
