...
from ..chapter_4.LocationsAndRegions import Ch4Regions
...
cross_chapter_conditional_locations: dict = {
    CCLocations.castle_town_ddburger_fusion.value: ConditionalLocationData(
        LocationIDs.cc_castle_town_dd_burger_fusion.value,
        fusion_access_region,
        lambda world: world.can_access_fusion(),
        LocationGroups.castle_town.value,
    ),
    CCLocations.castle_town_silver_card_fusion.value: ConditionalLocationData(
        LocationIDs.cc_castle_town_silver_card_fusion.value,
        fusion_access_region,
        lambda world: world.can_access_fusion(),
        LocationGroups.castle_town.value,
    ),
    ...
    CCLocations.castle_town_twin_ribbon_fusion.value: ConditionalLocationData(
        LocationIDs.cc_castle_town_twin_ribbon_fusion.value,
        fusion_access_region,
        lambda world: world.can_access_fusion()
    ...
    CCLocations.castle_town_spike_band_fusion.value: ConditionalLocationData(
        LocationIDs.ch2_castle_town_spike_band_fusion.value,
        fusion_access_region,
        lambda world: world.can_access_fusion()
    ...
    CCLocations.castle_town_tensionbow_fusion.value: ConditionalLocationData(
        LocationIDs.cc_castle_town_tension_bow_fusion.value,
        fusion_access_region,
        lambda world: world.can_access_fusion()
...
def get_cross_chapter_regions(world: "DeltaruneWorld"):
    ...
    if world.include_chapter(1):
        chapter_entraces.append(CCEntrances.chapter_1_entrance.value)
    if world.include_chapter(2):
        chapter_entraces.append(CCEntrances.chapter_2_entrance.value)
    if world.include_chapter(3):
        chapter_entraces.append(CCEntrances.chapter_3_entrance.value)
    if world.include_chapter(4):
        chapter_entraces.append(CCEntrances.chapter_4_entrance.value)

    regions.append((CCRegions.hub.value, chapter_entraces))

    if world.can_access_fusion():
        regions.append((fusion_access_region, []))
...
def get_cross_chapter_mandatory_connection(world: "DeltaruneWorld"):
    ...
    if world.include_chapter(1):
        connections.append((CCEntrances.chapter_1_entrance.value, Ch1Regions.chapter_1.value))
    if world.include_chapter(2):
        connections.append((CCEntrances.chapter_2_entrance.value, Ch2Regions.chapter_2.value))
    if world.include_chapter(3):
        connections.append((CCEntrances.chapter_3_entrance.value, Ch3Regions.chapter_3.value))
    if world.include_chapter(4):
        connections.append((CCEntrances.chapter_4_entrance.value, Ch4Regions.chapter_4.value))
...
def create_regions(world: "DeltaruneWorld"):
    generic_create_regions(
        world, get_cross_chapter_regions(world), cross_chapter_locations, cross_chapter_conditional_locations
    )
