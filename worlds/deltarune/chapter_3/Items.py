...
chapter3_conditional_items = {
    ...
    Ch3Items.remote_battery.value:    ConditionalItemData(ItemIDs.remote_battery.value, ItemClassification.progression_skip_balancing, lambda world: world.is_final_chapter(3), [ItemGroups.region_blockers], 0),
